...
export default function ForumPost() {
  ...
  if (!post) return <Layout><p className="p-4">Loading...</p></Layout>;

  return (
    <Layout>
      <div className="px-4 py-6 max-w-3xl mx-auto text-[#2c2c2c] font-serif">
        <h1 className="text-2xl font-extrabold text-[#283d63] mb-2">{post.title}</h1>
        ...
        <h2 className="mt-8 mb-2 text-lg font-bold text-[#283d63]">💬 Public Comments</h2>
        ...
        {comments.length === 0 ? (
          ...
          <div className="space-y-2 mb-4">
            {comments.map(c => (
              <div key={c.id} className="border-l-4 border-[#c2a76d] bg-[#fdf7ea] px-4 py-2 rounded">
